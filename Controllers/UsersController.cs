...
namespace AutoSalonGrida.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdUser,Name,Age,IdRole")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdUser,Name,Age,IdRole")] User user)
        {
            if (id != user.IdUser)
            {
                return NotFound();
